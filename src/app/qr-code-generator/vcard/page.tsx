...
export const metadata: Metadata = {
  ...
  description: 'Create digital business card QR codes. Share contact info instantly with a scan. Free vCard QR maker.',
  alternates: { canonical: '/qr-code-generator/vcard' },
};

export default function VcardVariationPage() {
  return (
    <div className="dot-pattern">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <nav className="flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400 mb-6">
          ...
          <span>/</span>
          <span className="text-slate-900 dark:text-white capitalize">vcard</span>
        </nav>
        ...
        <p className="text-lg text-slate-600 dark:text-slate-300 mb-8 max-w-2xl">
          Create digital business card QR codes. Share contact info instantly with a scan. Free vCard QR maker.
        </p>
        ...
        <article className="prose prose-slate dark:prose-invert max-w-none">
          <h2>Why vCard QR Code Generator?</h2>
          <p>
            Whether you&apos;re looking for a specialized tool or just want a streamlined experience,
            our QR Code Generator has everything you need. This page is optimized for <strong>vcard qr code generator free</strong> — 
