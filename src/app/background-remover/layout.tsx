...
export const metadata: Metadata = {
  title: 'AI Background Remover — Free, No Upload, 100% Private | SheruTools',
        ...
        mainEntity: [
          {
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Yes! You can remove backgrounds from up to 3 images per day for free. Pro users get unlimited access.',
            },
          },
          {
            '@type': 'Question',
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'No. All processing happens directly in your browser using AI. Your images never leave your device.',
            },
          },
          {
            '@type': 'Question',
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'JPG, PNG, WebP, and most common image formats are supported. Results are downloaded as transparent PNG.',
            },
          },
          {
            '@type': 'Question',
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Yes! After removing the background, you can replace it with a solid color, gradient, or your own custom image.',
            },
          },
        ],
      },
