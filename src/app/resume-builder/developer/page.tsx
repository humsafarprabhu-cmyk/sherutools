...
export const metadata: Metadata = {
  title: 'Developer Resume Builder Free',
  description: 'Build a developer resume that stands out. Showcase GitHub, tech stack, and projects. Free online tool.',
  alternates: { canonical: '/resume-builder/developer' },
};

export default function DeveloperVariationPage() {
  return (
    <div className="dot-pattern">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <nav className="flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400 mb-6">
          ...
          <span>/</span>
          <span className="text-slate-900 dark:text-white capitalize">developer</span>
        </nav>
        ...
        <p className="text-lg text-slate-600 dark:text-slate-300 mb-8 max-w-2xl">
          Build a developer resume that stands out. Showcase GitHub, tech stack, and projects. Free online tool.
        </p>
        ...
        <article className="prose prose-slate dark:prose-invert max-w-none">
          <h2>Why Resume Builder for Developers?</h2>
          <p>
            Whether you&apos;re looking for a specialized tool or just want a streamlined experience,
            our Resume Builder has everything you need. This page is optimized for <strong>developer resume builder free online</strong> — 
