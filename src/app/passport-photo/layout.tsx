...
export const metadata: Metadata = {
  title: 'AI Passport Photo Maker — Free Online Passport Photo Generator | SheruTools',
        ...
        mainEntity: [
          {
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Yes! You can create up to 2 passport photos per day for free. Pro users get unlimited access, HD quality, and print layouts.',
            },
          },
          {
            '@type': 'Question',
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'We support US, India, UK, EU/Schengen, Canada, Australia, China, and Japan passport photo standards with correct dimensions and DPI.',
            },
          },
          {
            '@type': 'Question',
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'No. All processing happens in your browser using Canvas API. Your photos never leave your device.',
            },
          },
          {
            '@type': 'Question',
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'US passport photos must be 2x2 inches (51x51mm / 600x600 pixels at 300 DPI) with a white background.',
            },
          },
          {
            '@type': 'Question',
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Yes! Pro users can generate a 4x6 inch print layout with multiple passport photos arranged for home printing.',
            },
          },
        ],
      },
