...
export const metadata: Metadata = {
  title: 'Subscription Tracker — See How Much You Waste Monthly',
  ...
  alternates: { canonical: 'https://sherutools.com/subscription-tracker' },
  twitter: {
    card: 'summary_large_image',
    title: 'Subscription Tracker — See How Much You Waste Monthly',
    description: 'Track all your subscriptions in one place. See your total monthly spend, get cancel reminders, and stop wasting money on forgotten subscriptions.',
