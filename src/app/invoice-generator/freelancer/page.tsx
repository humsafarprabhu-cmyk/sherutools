...
export const metadata: Metadata = {
  ...
  description: 'Create professional invoices as a freelancer. Free invoice maker with customizable templates — no signup required.',
  alternates: { canonical: '/invoice-generator/freelancer' },
};

export default function FreelancerVariationPage() {
  return (
    <div className="dot-pattern">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <nav className="flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400 mb-6">
          ...
          <span>/</span>
          <span className="text-slate-900 dark:text-white capitalize">freelancer</span>
        </nav>
        ...
        <p className="text-lg text-slate-600 dark:text-slate-300 mb-8 max-w-2xl">
          Create professional invoices as a freelancer. Free invoice maker with customizable templates — no signup required.
        </p>
        ...
        <article className="prose prose-slate dark:prose-invert max-w-none">
          <h2>Why Invoice Generator for Freelancers?</h2>
          <p>
            Whether you&apos;re looking for a specialized tool or just want a streamlined experience,
            our Invoice Generator has everything you need. This page is optimized for <strong>invoice generator for freelancers free</strong> — 
