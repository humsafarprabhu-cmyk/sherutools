...
export default function UpgradeModal({ open, onClose }: Props) {
  const handleCheckout = () => {
    window.open('https://sherutools.lemonsqueezy.com/checkout/buy/placeholder-resume', '_blank');
  };
        ...
        >
          ...
          >
            ...
            <div className="relative text-center mb-6">
              ...
              <p className="text-slate-400 text-sm mt-1">Unlock all resume builder features</p>
              <div className="mt-4">
