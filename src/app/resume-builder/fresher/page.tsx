...
export const metadata: Metadata = {
  title: 'Resume Builder for Freshers Free',
  description: 'Build your first resume with templates designed for freshers. Highlight education, skills, and projects. Free.',
  alternates: { canonical: '/resume-builder/fresher' },
};

export default function FresherVariationPage() {
  return (
    <div className="dot-pattern">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <nav className="flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400 mb-6">
          ...
          <span>/</span>
          <span className="text-slate-900 dark:text-white capitalize">fresher</span>
        </nav>
        ...
        <p className="text-lg text-slate-600 dark:text-slate-300 mb-8 max-w-2xl">
          Build your first resume with templates designed for freshers. Highlight education, skills, and projects. Free.
        </p>
        ...
        <article className="prose prose-slate dark:prose-invert max-w-none">
          <h2>Why Resume Builder for Freshers?</h2>
          <p>
            Whether you&apos;re looking for a specialized tool or just want a streamlined experience,
            our Resume Builder has everything you need. This page is optimized for <strong>resume builder for freshers free</strong> — 
