...
export const metadata: Metadata = {
  title: 'AI Image Upscaler — Enhance & Enlarge Images Free | SheruTools',
        ...
        mainEntity: [
          {
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Yes! You can upscale up to 3 images per day for free at 2x resolution. Pro users get unlimited 4x/8x upscaling.',
            },
          },
          {
            '@type': 'Question',
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Yes. Our tool uses high-quality interpolation combined with smart sharpening and optional denoising to produce crisp, detailed enlarged images.',
            },
          },
          {
            '@type': 'Question',
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'No. All processing happens directly in your browser. Your images never leave your device.',
            },
          },
          {
            '@type': 'Question',
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'JPG, PNG, WebP, and most common image formats. You can download results as PNG or JPG.',
            },
          },
          {
            '@type': 'Question',
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Free users can upload images up to 2MB. Pro users can upload up to 20MB.',
            },
          },
        ],
      },
